...
fields = [
    ...
    ("size_bytes", "integer", "Tamaño exacto del archivo original en bytes.", "sistema_archivos"),
    (
        "sha256_original",
        "string",
    ...
    ("attachment_count", "integer", "Adjuntos o piezas embebidas detectados por parser.", "parser"),
    (
    ...
    ("has_native_text", "boolean", "El parser encuentra texto nativo en el original.", "parser"),
    (
        "extraction_method",
        "string",
    ...
    "ejemplos_filtros.json",
    {
        ...
        "consultas": [
            ...
            },
            {
                ...
                "all": [
                    {"field": "tipo_documental", "op": "eq", "value": "protocolo_procedimiento"},
...
for g, name in GROUPS.items():
    ...
    for qid in ids:
        ...
        lines.append("")
(R / "catalogo_completo.md").write_text("\n".join(lines), encoding="utf-8")
